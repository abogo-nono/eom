...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.menu_docs_btn.setIcon(icon1)
        ...
        icon4 = QIcon()
        icon4.addFile(u":/light/icons/light/alert-triangle.svg", QSize(), QIcon.Normal, QIcon.Off)
        icon4.addFile(u":/dark/icons/dark/alert-triangle.svg", QSize(), QIcon.Normal, QIcon.On)
        self.menu_report_btn.setIcon(icon4)
        ...
        icon5 = QIcon()
        icon5.addFile(u":/outline/icons/outline/minus.svg", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon6 = QIcon()
        icon6.addFile(u":/outline/icons/outline/maximize-2.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.maximize_btn.setIcon(icon6)
        ...
        icon7 = QIcon()
        icon7.addFile(u":/outline/icons/outline/x.svg", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon8 = QIcon()
        icon8.addFile(u":/light/icons/light/alert-circle.svg", QSize(), QIcon.Normal, QIcon.Off)
        ...
        QWidget.setTabOrder(self.close_btn, self.about_btn)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.menu_docs_btn.setText(QCoreApplication.translate("MainWindow", u"Home", None))
